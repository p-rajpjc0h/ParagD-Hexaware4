...
import com.example.fullscreenvlibrary.listener.OnVideoCompletedListener;
import com.example.fullscreenvlibrary.listener.mediacontroller.MediaControllerListener;
import com.example.fullscreenvlibrary.model.Arguments;
import com.example.fullscreenvlibrary.model.Margins;
...
import com.example.fullscreenvlibrary.orientation.OrientationManager;
...
public class FullscreenVideoView extends FrameLayout
    ...
    private void init(AttributeSet attrs) {
        ...
        // Setup onTouch com.example.fullscreenvlibrary.listener
    ...
    @Override
    public void onInfoListnerPrepared(MediaPlayer.OnInfoListener listener) {
        fullscreenVideoMediaPlayer.setOnInfoListener(listener);
    }
    ...
    /**
     * Adds an error com.example.fullscreenvlibrary.listener which is called when an error occurs.
     *
     * @param onErrorListener com.example.fullscreenvlibrary.listener for errors
     * @return the fullscreenVideoView instance
     */
    ...
    /**
     * Adds a com.example.fullscreenvlibrary.listener which is called when the video playback is completed.
     *
     * @param listener the com.example.fullscreenvlibrary.listener for video completion
     * @return the fullscreenVideoView instance
     */
    ...
    /**
     * Adds a com.example.fullscreenvlibrary.listener for media controller events.
     *
     * @return the fullscreenVideoView instance
     */
    ...
    public void onOrientationChanged() {
        ...
        if (surfaceView != null && fullscreenVideoMediaPlayer != null) {
            surfaceView.updateLayoutParams(fullscreenVideoMediaPlayer.getVideoWidth(), fullscreenVideoMediaPlayer.getVideoHeight()
            );
        }
    }
